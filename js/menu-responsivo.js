...
//Não executa nenhuma ação enquanto o documento não estiver inteiramente carregado
(function() {
    ...
    //coloca uma nova tag no código fonte
    document.querySelector(".open-menu-mobile").appendChild(mobile);

    //seleciona a nav-mobile no código fonte
    var mobileNav = document.querySelector(".nav-mobile");

    //seleciona o nav-list
    var toggle = document.querySelector(".cf");
